...
const tags500CharactersDataSet = [
    ...
    {
      name: "Energía Renovable",
      description: "Descubre las innovaciones más recientes en energía renovable y su impacto en el medio ambiente. La energía renovable se refiere a las fuentes de energía que se regeneran de manera natural, como la solar, eólica, hidroeléctrica y geotérmica. A medida que el mundo busca reducir su dependencia de los combustibles fósiles y mitigar el cambio climático, las tecnologías de energía renovable están ganando terreno. Desde paneles solares más eficientes hasta turbinas eólicas avanzadas, las innovaciones en este campo están ayudando a crear un futuro más sostenible y limpio para todos."
    },
    {
      name: "Exploración Espacial",
    ...
    {
      name: "Neurociencia",
      description: "Aprende sobre los desarrollos más recientes en neurociencia y cómo están cambiando nuestra comprensión del cerebro. La neurociencia es el estudio del sistema nervioso y el cerebro, y los avances en este campo están revolucionando nuestra comprensión de la mente humana. Desde el mapeo de las conexiones neuronales hasta el desarrollo de terapias para enfermedades neurodegenerativas, los científicos están desentrañando los misterios del cerebro. Con el uso de tecnologías avanzadas como la neuroimagen y la inteligencia artificial, la neurociencia está abriendo nuevas vías para el tratamiento y la mejora de la salud mental."
    }
  ];
